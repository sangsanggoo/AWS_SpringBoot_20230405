...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='권한 부여';
...
INSERT INTO `authority_mst` VALUES (1,1,1),(2,2,1),(3,3,1);
...
INSERT INTO `course_mst` VALUES (1,1,1,'2023-04-01'),(2,2,1,'2023-04-01'),(3,3,1,'2023-04-01'),(4,4,1,'2023-04-01'),(5,1,2,'2023-04-01'),(6,3,2,'2023-04-01'),(7,5,2,'2023-04-01'),(8,7,2,'2023-04-01'),(9,3,3,'2023-04-01'),(10,4,3,'2023-04-01'),(11,5,3,'2023-04-01'),(12,6,3,'2023-04-01'),(13,8,3,'2023-04-01'),(14,1,4,'2023-04-01'),(15,5,4,'2023-04-01'),(16,6,4,'2023-04-01'),(17,7,4,'2023-04-01'),(18,8,4,'2023-04-01'),(19,11,4,'2023-04-01'),(20,5,5,'2023-04-01'),(21,7,5,'2023-04-01'),(22,8,5,'2023-04-01'),(23,10,5,'2023-04-01'),(24,9,6,'2023-04-01'),(25,10,6,'2023-04-01'),(26,11,6,'2023-04-01'),(27,4,7,'2023-04-01'),(28,5,7,'2023-04-01'),(29,6,7,'2023-04-01'),(30,1,8,'2023-04-01'),(31,5,8,'2023-04-01'),(32,8,8,'2023-04-01'),(33,9,8,'2023-04-01'),(34,10,8,'2023-04-01'),(35,11,8,'2023-04-01'),(41,1,11,'2023-04-12');
...
CREATE TABLE `instructor_mst` (
  ...
  PRIMARY KEY (`itm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='강사 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `instructor_mst` VALUES (1,'김영한','2023-01-10'),(2,'토비','2023-02-10'),(3,'김정환','2023-03-10'),(4,'조현영','2023-04-10'),(5,'김준일','1234-01-01'),(6,'김준일','1234-01-01');
...
CREATE TABLE `lecture_mst` (
  ...
  `itm_id` int NOT NULL,
  PRIMARY KEY (`ltm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='강의 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student_mst` VALUES (1,'김종환','2023-04-10'),(2,'고병수','2023-04-10'),(3,'손민재','2023-04-10'),(4,'황창욱','2023-04-10'),(5,'김상현','2023-04-10'),(6,'강대협','2023-04-10'),(7,'손지호','2023-04-10'),(8,'최해혁','2023-04-10'),(9,'상현','1999-01-27'),(10,'상현','1999-01-27'),(11,'상현','1999-01-27');
...
INSERT INTO `user_mst` VALUES (1,'이상현','$2a$10$IZf7zTPcJzO0GgrXtLZyyuZ7oCSzdtdN8kDNoud7Z0pLwD09Q8.Qe','상현','abc@naver.com'),(2,'삼상현','$2a$10$5NWPOUeXYCVbZwRXb9kOkOZCLaOsK4AnmoqaE8PhhIyFwRDmDYVBq','상현','abc@naver.com'),(3,'일상현','$2a$10$xmZ/M/7Vuj7AweMTvYgua.6VrgR/MClRYwdjbOy.QlmPMWUrgooAu','상현','abc@naver.com');
...
-- Dump completed on 2023-04-14 17:42:34
